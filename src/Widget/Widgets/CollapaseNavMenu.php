...
class CollapaseNavMenu extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number_of_show_items'); ?>">
                <?php echo esc_html(__('Show items:', 'jankx')); ?>
            </label>
            <input
                type="text"
                id="<?php echo $this->get_field_id('number_of_show_items'); ?>"
                name="<?php echo $this->get_field_name('number_of_show_items'); ?>"
                value="<?php echo array_get($instance, 'number_of_show_items', 5); ?>"
            />
        </p>
        <?php
    }
