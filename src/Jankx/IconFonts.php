...
class IconFonts
{
     ...
     */
    public static function add($font_name, $font_css_path, $version = null, $display_name = null)
    {
        ...
        if (!isset($instance->fonts[$font_name])) {
            ...
            do_action('jankx/icon/fonts/new', $font_name, $font_css_path, $display_name, $version);
        }
    }
